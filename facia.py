...
class OnlineClass:
    ...
    def student_logout(self, login_id):
        if login_id in self.students:
            ...
            if not record_df.empty:  # Ensure we only concatenate if the DataFrame is not empty
...
if __name__ == "__main__":
    ...
    online_class.add_student("Jane Smith", "sarthak.sharma_cs22@gla.ac.in", "jane123", "jane_face.jpg")
