...
class Student:
    ...
    def end_session(self):
        ...
        self.login_time = None  # Reset login time for the next session
    ...
    def get_details(self):
        return {
            ...
            'Duration (minutes)': round(self.total_attendance_duration, 2)  # Total duration across sessions
        }
...
if __name__ == "__main__":
    ...
    online_class.add_student('Jane Smith', 'jane_face.jpg')
